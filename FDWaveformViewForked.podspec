...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = "https://github.com/rcholic/FDWaveformView"
  ...
  s.source           = { :git => "https://github.com/rcholic/FDWaveformView.git", :tag => s.version.to_s }
  s.social_media_url = 'https://twitter.com/rcholic'
